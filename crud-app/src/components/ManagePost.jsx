    ...
    return (
        <div>
            ...
            <form onSubmit={onSubmit}>
                <input type='text' name='title' placeholder='Заголовок' value={formValues.title} onChange={onChangeValues} />
                <br></br>
                <br></br>
                <textarea name='body' cols='30' rows='10' value={formValues.body} onChange={onChangeValues} />
                <br></br>
                <br></br>
